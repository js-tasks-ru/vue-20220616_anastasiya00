<template>
  <fieldset class="agenda-item-form">
    ...
    <ui-form-group v-for="({ label, component, props }, key) in $options.agendaItemFormSchemas[type]" :key="key"
                   :label="label">
      <component v-model="localAgendaItem[key]" :is="component" v-bind="props" />
    </ui-form-group>
  </fieldset>
</template>
